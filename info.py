...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://eeee:eeee@cluster0.wb3ywgn.mongodb.net/?retryWrites=true&w=majority")
...
URL = environ.get("URL", "https://test-stream-316c89440fcd.herokuapp.com/")
if len(URL) == 0:
